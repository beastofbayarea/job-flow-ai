# Executive Hyper-Tailored Master Field & Answer Guide for August 08 Ashby Queue & Open Tabs

Based on Candidate Resume (`data/resumes/resume-general.pdf`) & Candidate Profile:
- **Candidate Name**: Shivam Singh (Shiv)
- **Email**: Assigned Unique Emails per Application from Candidate Email Pool
...
## 1. Linear — Demand Generation Lead, Growth
* **Company Profile**: Linear is the leading software issue-tracking and product management platform known for world-class design, speed, and developer craft.
* **URL**: `https://jobs.ashbyhq.com/Linear/910805ac-96e8-42b9-a8e9-8adf4c4ef536`

### Complete Field Answers:
1. **Name**: Shivam Singh
2. **Email**: shivamsin13@umich.edu
3. **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\linear-demand-generation-lead-growth.pdf`
4. **LinkedIn Profile**: https://linkedin.com/in/beastofbayarea
5. **Twitter**: https://x.com/BeastofBayArea
6. **What country are you based in?**: United States
7. **Are you based in a US or EU equivalent timezone?**: `Yes` (San Francisco, CA)
8. **Cover Letter**:
   > Linear has redefined modern software craft, focus, and product velocity for high-performing engineering teams. As a CS engineer (IIT B.Tech) and growth/product leader (AWS, Microsoft, D. E. Shaw, McKinsey), I deeply admire Linear’s refusal to sacrifice design excellence for growth metrics. Having architected multi-channel demand engines at Microsoft ($12M budget generating $50M GMV at 4.1x ROI) and scaled product retention loops at Rakuten (+33% D30 retention), I want to bring my background in propensity-scored channel attribution, developer community activation, and product-led growth to scale Linear’s reach across global software teams without losing its iconic product craft.
9. **Demand generation campaign lead**:
   > At Microsoft, I architected a $12M partner marketing and demand generation engine that shifted allocation from static co-marketing grants to real-time, propensity-scored budget shaping using Random Forest models. By dynamically directing MDF funds toward high-converting developer partner channels, we generated $50M in incremental GMV at a 4.1x ROI, increased funded partner conversion from 5% to 24%, and compressed partner sales cycles from 140 to 85 days. In hindsight, I would have integrated automated CRM intent triggers earlier to accelerate partner lead routing even further.
10. **Funnel bottleneck optimization**:
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\runway-ml-growth-marketing-manager-paid-channels.pdf`
1. **Name**: Shivam Singh | **Email**: shivamsi11@umich.edu | **Phone**: 6502833478
2. **Location**: San Francisco, CA | **LinkedIn**: https://linkedin.com/in/beastofbayarea
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\kestra-product-manager-data-orchestration.pdf`
1. **Name**: Shivam Singh | **Email**: shivamsing15@umich.edu | **Location**: San Francisco, CA
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\preply-digital-pr-growth-manager.pdf`
1. **Name**: Shivam Singh | **Email**: shivhere3@umich.edu
...
## 6. Tribe Ai — Product Marketing Lead
* **URL**: `https://jobs.ashbyhq.com/tribe-ai/186aa4dd-0578-4935-9e76-7938533503d8`

### Complete Field Answers:

* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\tribe-ai-product-marketing-lead.pdf`
1. **Name**: Shivam Singh | **Email**: shivamsing10@umich.edu | **Location**: San Francisco, CA
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\coder-senior-product-marketing-manager.pdf`
1. **Name**: Shivam Singh | **Email**: shivamsi26@umich.edu | **Preferred Name**: Shiv
2. **Links**: https://github.com/beastofbayarea | https://linkedin.com/in/beastofbayarea
3. **How did you hear about this job?**: LinkedIn
4. **What interests you in Coder?**:
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\helpscout-lead-principal-product-manager-growth.pdf`
1. **Full Name**: Shivam Singh | **Email**: shivamsingh7@umich.edu | **Pronouns**: `they/them`
2. **Why are you interested in Help Scout & this role?**:
   > Help Scout’s customer-centric mission and human-first culture resonate strongly with my product philosophy. As a product and growth leader who scaled digital consumer apps at Rakuten (doubling D30 retention from 34% to 67%) and launched GenAI customer tools at AWS (+15% session depth), I thrive on finding high-leverage product friction points and building intuitive PLG user onboarding flows that drive long-term customer retention.
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\element451-director-of-growth-marketing.pdf`
1. **Name**: Shivam Singh | **Email**: shivamsingh47@umich.edu | **Location**: San Francisco, CA
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\netboxlabs-technical-program-manager.pdf`
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\elevenlabs-marketing-operations.pdf`
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\openai-technical-program-manager-rack-delivery.pdf`
1. **Legal Name**: Shivam Singh | **Email**: shivamsi4@umich.edu | **Start Date**: `2 weeks`
2. **Infrastrucutre/Datacenter TPM Experience**:
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\aiprise-senior-content-marketing-manager.pdf`
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\pano-ai-technical-program-manager-hardware-deployment-contract.pdf`
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\goodparty-product-marketing-lead.pdf`
1. **Full Name**: Shivam Singh | **Email**: shivamsing2@umich.edu
2. **Introduce yourself (<300 chars)**:
   > Product leader with an IIT CS degree & Ross MBA. At AWS, I led agentic AI solutions used by millions; at D. E. Shaw & McKinsey, I scaled data platforms. Passionate about applying AI to democratize civic access and voter empowerment.
3. **Why GoodParty.org?**:
   > GoodParty.org’s mission to end political duopoly by empowering independent candidates through technology resonates deeply with me. I want to apply my product strategy and AI engineering background to build tools that equalize campaign access and activate grassroots movements.
4. **AI Problem Solved**:
   > Challenge: High hallucination rates (8%+) and slow session depth in conversational shopping assistant across 12 workstreams at AWS.
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\synthesia-field-marketing-manager-us.pdf`
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\cohere-technical-program-manager-ai-delivery-korea.pdf`
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\infisical-growth-marketing-manager.pdf`
1. **Name**: Shivam Singh | **Email**: shivamsing19@umich.edu
2. **3 Bullets showing exceptional ability**:
   - **GTM & Pipeline Engine**: Built a $12M partner marketing engine at Microsoft using Random Forest propensity scoring and budget traffic-shaping; drove $50M incremental GMV at 4.1x ROI and raised partner conversion 5% -> 24%.
...
* **Resume**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\personalized-resumes\ashby-2026-08-08\confluent-staff-security-risk-compliance-program-manager-access-management.pdf`
...
## ADDITIONAL ACTIVE BROWSER OPEN TAB APPLICATIONS

### 25. Coder — Senior Product Manager
* **URL**: `https://jobs.ashbyhq.com/coder/0dade34e-3141-4c69-bef8-7ebfdc72bf72/application`

#### Complete Field Answers:
1. **Name**: Shivam Singh
2. **Preferred Name**: Shiv
3. **Email**: shivamsingh18@umich.edu
4. **Links (GitHub, portfolio, website, LinkedIn)**: `https://github.com/beastofbayarea | https://linkedin.com/in/beastofbayarea`
5. **How did you hear about this job?**: `LinkedIn`
6. **What interests you in Coder?**:
   > As a CS graduate from IIT who built mission-critical developer platforms at D. E. Shaw (Rust, Flink, Kafka) and cloud developer tools at AWS and Microsoft, Coder’s vision for cloud development environments (CDEs) represents the future of developer speed and security. I want to bring my technical PM background scaling developer-facing infrastructure to expand Coder’s product roadmap and enterprise developer footprint.
7. **Visa Sponsorship**: `No`
8. **Resume Upload**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\Coder - Senior Product Manager - Personalized Resume.pdf`

---

### 26. Audiohook — Product Marketing Manager
* **URL**: `https://jobs.ashbyhq.com/audiohook/5d8e16bb-6bc9-4294-9762-37419ad319fa/application`

#### Complete Field Answers:
1. **Name**: Shivam Singh
2. **Email**: shivamsin4@umich.edu
3. **Tell us about a specific time you improved customer activation or time-to-value**:
   > At AWS, enterprise banking clients faced 6-month onboardings due to complex compliance reviews. I identified activation bottlenecks through funnel telemetry and shipped pre-packaged compliance-as-code reference architectures and localized security toolkits. This reduced client onboarding time from 6 months to 2 hours, unlocked $20M+ immediate commitments, and built a $122M pipeline.
4. **Describe a positioning or messaging shift you led**:
   > At Rakuten, our consumer app positioning focused on DTC discount shoppers, leading to high CAC ($42) and poor D30 retention (34%). Through cohort analytics and customer interviews, I led a repositioning shift from consumer DTC rewards to B2B2C corporate employee perks. I validated the direction through pilot sales decks and joint beta testing with enterprise partners, improving LTV:CAC from 0.8 to 4.5, boosting D30 retention from 34% to 67%, and dropping CAC to $8.50.
5. **Walk us through a product launch you owned end-to-end. What is the single decision you're least proud of in hindsight**:
   > I owned the end-to-end launch of our GenAI shopping assistant copilot at AWS across 12 workstreams. In hindsight, the decision I am least proud of was launching with a broad multi-category prompt template rather than segmenting prompts by product vertical on day 1. This caused initial domain hallucinations in specialized categories. We quickly pivoted by deploying vertical-specific RAG embeddings and Bedrock Guardrails, which reduced hallucinations from 8% to 2.8%.
6. **Tell us about a time customer or win/loss research changed your mind about something**:
...
7. **How do you use AI tools in your product marketing work today?**:
   > I use GenAI tools daily for market positioning research, drafting messaging variants, and automating competitive intelligence. In one instance, using Claude/Bedrock prompt chains to analyze 500+ customer feedback transcripts helped us isolate key value propositions in hours, accelerating our messaging framework launch. Conversely, when attempting to use AI to generate complete customer case study narratives, the output lacked authentic customer nuance and required a complete manual rewrite to restore human credibility.
8. **Please share your desired salary**: `$120,000–$160,000 USD`
9. **Resume Upload**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\Audiohook - Product Marketing Manager - Personalized Resume.pdf`

---

### 27. Tapcart Inc. — Demand Gen Director
* **URL**: `https://jobs.ashbyhq.com/tapcart/a0c241a5-d1b4-421d-98a2-685497984662/application`

#### Complete Field Answers:
1. **Your Name**: Shivam Singh
2. **Email**: shivamsi19@umich.edu
3. **LinkedIn Profile**: `https://linkedin.com/in/beastofbayarea`
4. **Location**: `San Francisco, California, United States`
5. **US Work Authorization**: `Yes`
6. **In 3-5 sentences, walk us through a demand gen program you built or owned**:
   > At Microsoft, I architected a $12M partner marketing and demand generation engine that shifted allocation from static co-marketing grants to real-time, propensity-scored budget shaping using Random Forest models. The channel mix spanned paid search, programmatic display, and partner co-sell programs, generating $50M in incremental GMV at a 4.1x ROI, boosting partner conversion from 5% to 24%, and compressing sales cycles to 85 days. In hindsight, I would have integrated automated CRM intent triggers earlier to accelerate partner lead routing even further.
7. **Describe a workflow or system you've built using AI tools**:
   > Challenge: High hallucination rates (8%+) and slow session depth in conversational shopping assistants across 12 workstreams at AWS.
...
8. **Resume Upload**: `C:\Users\Nagarro\Downloads\job-flow-ai\output\Tapcart - Demand Gen Director - Personalized Resume.pdf`
