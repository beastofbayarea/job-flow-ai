...
16. **Desired Base Salary**: Open to the role's posted range; target $120,000-$160,000 USD base equivalent, negotiable based on scope, location, and total compensation.
...
- **Cover letter (Optional)** *(Optional)*: I am drawn to GoTymeX because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At Rakuten, I used cohort analytics, SQL, and geo-lift testing to help shift a DTC thesis toward B2B2C partnerships, improving LTV:CAC from 0.8 to 4.5, D30 retention from 34% to 67%, CAC from $42 to $8.50, and payback from 18 to four months. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Are you aware of any positions, relationships or any other matters that could give arise to real or apparent conflicts of interest if you obtain the position you have applied for?** *(Required)*: No known actual or apparent conflicts of interest.
- **Do you have any relatives or associates that have any prior or present association with any organisation or individual that could be considered a real or apparent conflict of interest if you are successful in obtaining the position you have applied for?** *(Required)*: No known actual or apparent conflicts of interest.
- **How many years of hands-on experience do you have in product management, and could you share some examples of the products or projects you've managed?** *(Required)*: 10+ years of product and platform leadership across AWS, Microsoft, Rakuten, and D. E. Shaw. Examples include an AWS agentic-AI copilot portfolio across 12 workstreams, a Microsoft partner growth platform, and Rakuten lifecycle and retention products.
- **Can you tell us about your experience working with service interactions, including the types of channels or platforms you've managed and any notable achievements?** *(Required)*: My closest experience is building enterprise self-service and AI-assisted product journeys, instrumenting customer telemetry, and coordinating platform and operations teams. At AWS, I reduced rollout time from six months to two hours and improved session depth by 15%.
- **What experience do you have with voice customer service channels, such as call centers or IVR systems? Please describe your role and any challenges you addressed.** *(Required)*: No dedicated call-center title; 10+ years of adjacent experience leading customer-facing platforms, operations, risk, service workflows, and global technical programs.
- **Could you share your experience managing or designing chat customer service channels? What platforms have you worked with, and what improvements did you help implement?** *(Required)*: I have led conversational and agentic-AI product work at AWS, including prompt design, RAG, guardrails, evaluation, routing, escalation, and telemetry. I improved product quality to 2.8% hallucinations and increased session depth by 15%, experience that transfers directly to AI-assisted service chat.
- **What is your background working with email customer service channels? How have you contributed to optimizing email workflows or resolution processes?** *(Required)*: I have optimized lifecycle and partner communications through analytics, automation, segmentation, conversion measurement, and closed-loop performance reporting. My strongest contribution is designing the workflow, prioritization, and measurement layer that improves response quality and resolution efficiency.
- **Can you describe your experience with self-service customer channels, including any strategies or solutions you've developed to improve customer autonomy?** *(Required)*: I design self-service around clear task completion, guided workflows, searchable knowledge, proactive diagnostics, and escalation when confidence is low. At AWS, this approach helped compress deployment from six months to two hours.
- **By submitting this form, I hereby agree to the terms of TYME GROUP's Personal Data Privacy Policy posted at: https://bit.ly/413NHFm** *(Required)*: Yes - I have reviewed the policy and consent to the stated processing for recruitment purposes. Options: YES / NO.

---------------------------------------------------------------------------------

## 3. Worth AI — Technical Product Manager (August 04 Queue)
...
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **LinkedIn** *(Required)*: https://linkedin.com/in/beastofbayarea
- **Cover letter (Optional)** *(Optional)*: I am drawn to Worth AI because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. My IIT Computer Science degree, Ross MBA in strategy, technology and operations, and LSE executive coursework let me connect engineering depth, commercial judgment, economics, and public-policy constraints. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Are you eligible to work in the United States?** *(Required)*: Yes Options: YES / NO.
- **Are you able to work in the U.S. WITHOUT any need for visa or employment sponsorship, now or in the future?** *(Required)*: Yes Options: YES / NO.
- **Do you have experience in FinTech** *(Required)*: Yes — financial-services and real-time data-platform experience at D. E. Shaw. Options: YES / NO.
- **Were you referred by a current employee? If so, who?** *(Required)*: No / N/A.
- **What is your desired base salary requirement?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.

---------------------------------------------------------------------------------

## 4. Salla — Staff Product Manager - Enterprise (August 04 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Photo upload** *(Required)*: Upload a current professional headshot in JPG, JPEG, GIF, or PNG format. **Candidate-supplied image required; no suitable photo was included with the resume.**
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **Nationality** *(Required)*: Indian.
- **Iqama Status** *(Required)*: I need a new Saudi work visa. Options: I`m Saudi National / I Have transferable Iqama / I Need new visa.
...
- **Have you owned the enterprise or top tier of a multi-tenant software or commerce platform (a tier with service commitments, API contracts, or organizational complexity)? If yes: name the platform and tier, the metric you owned, and one number you moved.** *(Required)*: Yes — I owned enterprise AI-platform capabilities at AWS across 12 workstreams, including security, guardrails, APIs, rollout, and adoption. I increased session depth by 15% and reduced hallucinations from 8% to 2.8%.
- **Have you personally owned multi-storefront, headless/API, or multi-market (currency and tax) product capability? If yes: which capability, and the hardest decision inside it.** *(Required)*: My closest directly relevant ownership is headless/API and multi-market platform architecture: at AWS I designed reusable sovereign-cloud reference architectures and compliance-as-code across regulated markets, reducing deployment from six months to two hours. The hardest decision was standardizing the common control plane while preserving country-specific data-sovereignty and resilience requirements.
- **What is your current salary in Saudi Riyals ?** *(Required)*: Prefer not to disclose current compensation at the application stage. I am happy to discuss expectations in the context of role scope, level, location, and total compensation.
- **Do you have relatives in Salla? If Yes, please clarify ..** *(Required)*: No / N/A.
- **Do you have any criminal records? If yes, please clarify ..** *(Required)*: No.
- **Please provide us with the names of two references in your previous or current work ...** *(Required)*: Reference 1 — **[candidate to enter name, title, company, relationship, email, and phone]**; Reference 2 — **[candidate to enter name, title, company, relationship, email, and phone]**. The resume does not identify referees, so real names must be supplied before submission.

---------------------------------------------------------------------------------

## 5. NobleAI — Product Manager (Science-Based AI Platform) (August 04 Queue)
...
- **Last name** *(Required)*: Singh
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to NobleAI because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At D. E. Shaw, I led a roughly $10M real-time risk platform across 15+ engineers, scaling throughput to 5.4M messages per second, cutting latency from 90ms to 4.2ms, reducing false positives from 15% to 1.8%, and unlocking $85M in regulatory capital. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.

---------------------------------------------------------------------------------

## 6. Valsoft / DemandBridge — Product Manager (US) – ERP Platform, AI-enabled workflows (August 04 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Salary expectations** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Valsoft Corporation because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At Microsoft, I built a $12M marketing-operations and partner-capital engine using propensity scoring, W-shaped attribution, real-time budget traffic-shaping, and API governance; it produced $50M incremental GMV at 4.1x ROI and raised partner conversion from 5% to 24%. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Are you legally authorized to work in the US?** *(Required)*: Yes Options: YES / NO.
- **Will you now or in the future require employer sponsorship to work in the US?** *(Required)*: No Options: YES / NO.

---------------------------------------------------------------------------------

## 7. GetResponse — Product Manager – Lifecycle Automation Platform (August 04 Queue)
...
- **What are your monthly salary expectations (gross)?** *(Required)*: $10,000–$13,333 USD gross per month, negotiable based on scope and total compensation.
...
## 8. Vasion — Senior Growth Marketing Manager (August 04 Queue)
...
- **Last name** *(Required)*: Singh
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **Do you have any relatives currently working for us? If so, please provide us with their name.** *(Required)*: No / N/A.
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Vasion because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At D. E. Shaw, I led a roughly $10M real-time risk platform across 15+ engineers, scaling throughput to 5.4M messages per second, cutting latency from 90ms to 4.2ms, reducing false positives from 15% to 1.8%, and unlocking $85M in regulatory capital. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
...
- **Are you legally authorized to work in the U.S. on a full-time basis?** *(Required)*: Yes Options: YES / NO.
- **Are you legally authorized to work in the United States without continuing sponsorship for employment visa status, now or in the future? (e.g., H-1B or H4)** *(Required)*: Yes Options: YES / NO.

---------------------------------------------------------------------------------

## 9. Skylight — Senior Growth Marketing Manager (August 04 Queue)
...
- **Last name** *(Required)*: Singh
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Skylight because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At McKinsey, I designed elasticity-based retail pricing across key-value and long-tail portfolios, unlocking $50M in revenue and reducing speed-to-market from six weeks to under one week through agile pods, hindcasting, and change management. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Are you legally authorized to work in the United States without sponsorship?** *(Required)*: Yes Options: YES / NO.
...
## 10. Infosys Singapore & Australia — Principal Consultant - Intelligent Marketing and AI (August 04 Queue)
...
## 11. Hospitable — Senior Product Manager (USA/Europe – Remote) (August 04 Queue)
...
- **Last name** *(Required)*: Singh
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **How many years of product management experience do you have?** *(Required)*: 10+ years of product and platform leadership across AWS, Microsoft, Rakuten, and D. E. Shaw. Examples include an AWS agentic-AI copilot portfolio across 12 workstreams, a Microsoft partner growth platform, and Rakuten lifecycle and retention products.
- **What is Andrew's favorite ice cream flavor?** *(Required)*: Pistachio. Options: Salted caramel / Cookies & Cream / Cherry Garcia / Dark chocolate / Pistachio.
- **Tell us about a product, feature, or business line you owned. What customer problem were you solving, what did you build, and what changed as a result?** *(Required)*: At AWS, I have led agentic AI and copilot strategy across 12 workstreams, using customer telemetry and experiments to increase session depth by 15%, reduce hallucinations from 8% to 2.8% with RAG and guardrails, and compress client rollout cycles from six months to two hours.
- **What excites you most about joining Hospitable as a Staff Product Manager?** *(Required)*: The role combines complex customer problems, measurable product outcomes, and cross-functional execution. I am especially drawn to the opportunity to pair technical depth with customer-led strategy and measurable growth.

---------------------------------------------------------------------------------

## 12. Lucidya — Principal Product Manager - Customer Service Suite (August 04 Queue)
...
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Lucidya because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At D. E. Shaw, I led a roughly $10M real-time risk platform across 15+ engineers, scaling throughput to 5.4M messages per second, cutting latency from 90ms to 4.2ms, reducing false positives from 15% to 1.8%, and unlocking $85M in regulatory capital. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **What is your Nationality?** *(Required)*: Indian.
- **Are you fluent in English (written and spoken)?** *(Required)*: Yes Options: YES / NO.
- **How many years experience do you have in Product Managment, and how many of these years have been in B2B SaaS?** *(Required)*: 10+ years of product and platform leadership, including approximately 8+ years in enterprise B2B cloud, data, AI, and financial-platform environments.
- **Have you built or managed products in the customer service, customer support, helpdesk, ticketing, or contact centre domain?** *(Required)*: Yes - I have managed AI-assisted customer journeys, self-service workflows, conversational experiences, telemetry, routing, escalation, and enterprise platform integrations. My deepest experience is the AI and workflow layer rather than a standalone helpdesk vendor.
- **Tell us about a B2B SaaS product or product suite you've owned end-to-end.** *(Required)*: At AWS, I have led agentic AI and copilot strategy across 12 workstreams, using customer telemetry and experiments to increase session depth by 15%, reduce hallucinations from 8% to 2.8% with RAG and guardrails, and compress client rollout cycles from six months to two hours.
- **What is you current salary in USD?** *(Required)*: Prefer not to disclose current compensation at the application stage. I am happy to discuss expectations in the context of role scope, level, location, and total compensation.
- **What is your salary expectation in USD?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.

---------------------------------------------------------------------------------

## 13. Seeq — AI GTM Manager (August 04 Queue)
...
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Seeq because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At McKinsey, I enabled a $1.1B APAC market entry by translating Vietnam and Indonesia data-localization rules into data-platform architecture and GTM choices for CFO, CIO, and CMO stakeholders. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **3 References (1 Direct Manager)** *(Required)*: Three senior professional references, including a direct manager, are available upon request at the appropriate stage of the process.
- **Have you personally designed and deployed AI-enabled workflows that improved a go-to-market, marketing, or revenue process?** *(Required)*: Yes — I have designed and operationalized AI-enabled workflows, prompt and guardrail requirements, RAG evaluation, and enterprise tool integrations at AWS. Options: YES / NO.
- **Do you have 7+ years of experience in marketing operations, revenue operations, GTM systems, automation, applied AI, solutions engineering, or a similar role within a complex B2B SaaS or enterprise environment?** *(Required)*: Yes - my experience spans Microsoft marketing operations, AWS GTM, Rakuten growth, and McKinsey commercial strategy, with direct ownership of planning, execution, analytics, and executive outcomes. Options: YES / NO.
- **Do you have hands-on experience with prompt engineering, workflow orchestration, automation logic, and tool integration?** *(Required)*: Yes — I have designed and operationalized AI-enabled workflows, prompt and guardrail requirements, RAG evaluation, and enterprise tool integrations at AWS. Options: YES / NO.
- **Have you managed or coached a small team while remaining hands-on in building workflows or automation solutions?** *(Required)*: Yes. I have led cross-functional work across 12 workstreams while remaining hands-on with product requirements, workflow design, metrics, and technical trade-offs.

---------------------------------------------------------------------------------

## 14. HSI — AI Product Manager I (August 04 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Do you actively reside in the continental USA?** *(Required)*: Yes Options: Yes / No.
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Salary Expectation** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.
- **If you were referred by an HSI employee, please enter their name below. If not, please write "N/A.** *(Required)*: No / N/A.
- **Cover letter (Optional)** *(Optional)*: I am drawn to HSI because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. My IIT Computer Science degree, Ross MBA in strategy, technology and operations, and LSE executive coursework let me connect engineering depth, commercial judgment, economics, and public-policy constraints. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Do you have hands-on experience building or managing AI/ML-powered products in a production environment?** *(Required)*: Yes — production GenAI and agentic-AI work at AWS, including RAG, Bedrock Guardrails, prompt/evaluation requirements, and measurable hallucination reduction. Options: YES / NO.
- **Do you have experience working with large language models (LLMs) in a product context (beyond exploration or experimentation)?** *(Required)*: Yes — production GenAI and agentic-AI work at AWS, including RAG, Bedrock Guardrails, prompt/evaluation requirements, and measurable hallucination reduction. Options: YES / NO.
- **Have you directly defined product requirements for AI systems, including prompts, guardrails, or evaluation criteria?** *(Required)*: Yes — production GenAI and agentic-AI work at AWS, including RAG, Bedrock Guardrails, prompt/evaluation requirements, and measurable hallucination reduction. Options: YES / NO.
- **How do you use AI tools (e.g., ChatGPT, Copilot) in your product-management workflows? (Select all that apply regularly)** *(Required)*: Select **Writing or refining product requirements; Prototyping product experiences or conversational flows; and Analyzing customer feedback or product data**. Do not select “I do not regularly use AI tools.”
- **Writing or refining product requirements** *(Required)*: Select.
- **Prototyping product experiences or conversational flows** *(Required)*: Select.
- **Analyzing customer feedback or product data** *(Required)*: Select.
- **I do not regularly use AI tools in my workflows** *(Required)*: Do not select.

---------------------------------------------------------------------------------

## 15. Gridium — Product Manager - Data and Integrations (August 04 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Cover letter** *(Required)*: I am drawn to Gridium because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At AWS, I architected a sovereign-cloud GTM for regulated banking, translating data sovereignty into reference architectures and compliance-as-code that unlocked $20M+ in commitments, built a $122M pipeline, and reduced deployment from six months to two hours. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **What is the biggest roadblock you have faced with a data integration and how did you solve it to get the data you needed?** *(Required)*: At D. E. Shaw, I built real-time data platforms processing 5.4M messages per second. I aligned data contracts and ownership, instrumented quality and latency, added replay and observability, and partnered with upstream and downstream teams to resolve integration bottlenecks.
- **What makes you interested in the mission of Gridium?** *(Required)*: The role combines complex customer problems, measurable product outcomes, and cross-functional execution. Gridium’s use of data to improve building efficiency is especially compelling because it turns difficult integrations into measurable environmental and operating impact.
- **How have you used AI tools to accelerate workflow for your teammates?** *(Required)*: I use LLMs and workflow automation to synthesize customer feedback, draft and critique requirements, generate test cases, analyze support themes, and prototype conversational flows. I pair automation with human review and evaluation criteria so speed does not come at the cost of accuracy.

---------------------------------------------------------------------------------

## 16. Ripjar — Product Manager (August 04 Queue)
...
- **Last name** *(Required)*: Singh
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **Summary** *(Required)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
...
- **Are you currently or have you previously worked for a SaaS business?** *(Required)*: Yes — predominantly enterprise B2B SaaS and digital platforms. Options: YES / NO.
- **Do you have B2B product experience?** *(Required)*: Yes — predominantly enterprise B2B SaaS and digital platforms. Options: YES / NO.
- **Do you currently live in the UK?** *(Required)*: No — current location is San Francisco, California. Options: YES / NO.
- **Do you have any FinCrime/Risk/AML,KYC previous experience at all?** *(Required)*: Yes - at D. E. Shaw I led a Basel III-controlled real-time risk platform across trading, compliance, IT, finance, and quant teams, reducing false positives from 15% to 1.8% and unlocking $85M in regulatory capital. Options: YES / NO.
- **I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application. / I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application.** *(Optional)*: Yes - I have reviewed the policy and consent to the stated processing for recruitment purposes.

---------------------------------------------------------------------------------

## 17. Pavago — Product Marketing & GTM Lead (August 04 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Please share your LinkedIn Profile URL.** *(Required)*: https://linkedin.com/in/beastofbayarea
- **Have you worked as an early GTM hire (employee #1–10) in a B2B SaaS startup? If yes, what was your exact role in the first product launch?** *(Required)*: No - I was not an employee #1-10 startup GTM hire. My closest equivalent is zero-to-one GTM leadership at AWS, where I built a sovereign-cloud offer and commercial motion that unlocked $20M+ in commitments and a $122M pipeline.
- **Can you describe a product launch you have led end-to-end? Please outline the specific actions you personally executed (not just supported).** *(Required)*: Yes. At Microsoft, I built a $12M partner marketing and demand-generation engine using propensity scoring and budget traffic-shaping, generating $50M in incremental GMV at 4.1x ROI and increasing partner conversion from 5% to 24%. At Rakuten, I helped reposition the GTM motion, reduced CAC from $42 to $8.50, increased D30 retention from 34% to 67%, and improved LTV:CAC from 0.8 to 4.5.
- **Have you been responsible for acquiring and onboarding beta users? What channels or strategies did you use to do this?** *(Required)*: Yes - I have acquired and activated early users through customer discovery, partner channels, targeted outreach, lifecycle journeys, product instrumentation, and feedback loops. I use explicit activation criteria, cohort retention, qualitative interviews, and rapid release cycles to turn early-user evidence into launch decisions.

---------------------------------------------------------------------------------

## 18. Lucidya — Senior Product Manager - Monitoring & Research (August 04 Queue)
...
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Lucidya because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At McKinsey, I enabled a $1.1B APAC market entry by translating Vietnam and Indonesia data-localization rules into data-platform architecture and GTM choices for CFO, CIO, and CMO stakeholders. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **What is your nationality?** *(Required)*: Indian.
- **Are you fluent in English & Arabic?** *(Required)*: No - professionally fluent in English; Arabic proficiency is not listed. Options: YES / NO.
- **Describe a B2B SaaS product you managed that relied heavily on data, analytics, or AI. What outcome did it achieve?** *(Required)*: At AWS, I have led agentic AI and copilot strategy across 12 workstreams, using customer telemetry and experiments to increase session depth by 15%, reduce hallucinations from 8% to 2.8% with RAG and guardrails, and compress client rollout cycles from six months to two hours.
- **Have you worked with social listening, Voice of Customer, customer intelligence, or research platforms? If yes, which ones and in what capacity?** *(Required)*: I have built Voice-of-Customer loops using product telemetry, qualitative feedback, experimentation, cohort analytics, and lifecycle data to identify needs and prioritize changes. At AWS those loops contributed to 25% adoption, 70% brand favorability, and 15% higher session depth; at Rakuten they helped lift D30 retention from 34% to 67%.
- **What is your current salary in USD?** *(Required)*: Prefer not to disclose current compensation at the application stage. I am happy to discuss expectations in the context of role scope, level, location, and total compensation.
- **What is your salary expectation in USD?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.

---------------------------------------------------------------------------------

## 19. LawnStarter — Senior Product Manager, Service Delivery (August 04 Queue)
...
## 20. WATI.io — Senior Product Manager/Product Manager - Platform (August 04 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Current Monthly Salary (USD)** *(Required)*: Prefer not to disclose current compensation at the application stage. I am happy to discuss expectations in the context of role scope, level, location, and total compensation.
- **Current Expected Salary (USD)** *(Required)*: $12,500 USD gross per month, negotiable based on scope and total compensation.

---------------------------------------------------------------------------------

## 21. Lucidya — Senior Product Manager - AI Agent Platform (August 04 Queue)
...
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Lucidya because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At D. E. Shaw, I led a roughly $10M real-time risk platform across 15+ engineers, scaling throughput to 5.4M messages per second, cutting latency from 90ms to 4.2ms, reducing false positives from 15% to 1.8%, and unlocking $85M in regulatory capital. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Do you have 5 or more years of experience as a Product Manager in B2B SaaS environments?** *(Required)*: Yes Options: YES / NO.
- **Have you managed or contributed to products that leverage AI-powered features (excluding building AI models)? Please explain briefly?** *(Required)*: At AWS, I have led agentic AI and copilot strategy across 12 workstreams, using customer telemetry and experiments to increase session depth by 15%, reduce hallucinations from 8% to 2.8% with RAG and guardrails, and compress client rollout cycles from six months to two hours.
- **Are you a native Arabic speaker with professional proficiency in English?** *(Required)*: No - professionally fluent in English; Arabic proficiency is not listed. Options: YES / NO.
- **What is your Nationality?** *(Required)*: Indian.
- **What is your current salary in USD?** *(Required)*: Prefer not to disclose current compensation at the application stage. I am happy to discuss expectations in the context of role scope, level, location, and total compensation.
- **What is your salary expectation in USD?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.
...
## 22. Writesonic — AI Product Manager (Builder PM, GEO Platform) (August 04 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Cover letter** *(Required)*: I am drawn to Writesonic because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. My IIT Computer Science degree, Ross MBA in strategy, technology and operations, and LSE executive coursework let me connect engineering depth, commercial judgment, economics, and public-policy constraints. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Link to something you've built or prototyped using AI coding tools. Doesn't need to be polished -we want to see that you actually build. (GitHub, Loom, deployed link -anything.)** *(Required)*: https://github.com/beastofbayarea and https://www.researchgate.net/profile/Shivam-Singh-188
- **What's one UX decision in an AI product that looks small but makes a huge difference to users? Why does it matter** *(Required)*: Showing confidence, sources, and a clear recovery path looks small but materially changes trust. Users need to know when to rely on an answer, inspect evidence, or escalate; without those cues, even accurate AI feels unpredictable.
...
- **Please share your current and expectated compensation** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.

---------------------------------------------------------------------------------

## 23. WATI.io — Technical Product Manager - B2B Platform (August 04 Queue)
...
## 24. Fuku — Product Manager – AI-Powered Recruiting Workflows (August 04 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- No additional live fields were found beyond the baseline personal-information and resume fields already listed above.

---------------------------------------------------------------------------------

## 25. NoGood — Product Manager (Goodie AI) (August 04 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Share your portfolio with us (digital link) (Optional)** *(Optional)*: https://github.com/beastofbayarea and https://www.researchgate.net/profile/Shivam-Singh-188
- **Share your portfolio with us (file) (Optional)** *(Optional)*: Leave blank; the GitHub and ResearchGate URLs above provide the portfolio materials without duplicating them in an attachment.
- **Consent to Record Interviews: By submitting this application, I acknowledge and provide my consent to NoGood/Berma LLC to record video interviews as part of the hiring process. I understand that these recordings may be used for evaluation, review, and recruitment purposes only, and will be handled in accordance with applicable privacy and data protection laws.** *(Required)*: I agree and consent to the recording of virtual interviews for recruitment evaluation under the stated policy. Options: I agree and I consent to the recording of any interview that takes place virtually while participating the interview process with NoGood / I disagree and do not consent to the recording of virtual interviews while participating int he interview process with NoGood.
- **Where are you located? (Optional)** *(Optional)*: San Francisco, California, United States (94108)
- **What topics do you create content for? (Select all that apply)** *(Optional)*: Select **AI & Tech, Finance, Education, and Business**.
- **AI & Tech** *(Optional)*: Select.
- **Health & Wellness** *(Optional)*: Do not select unless the application requires one category; the resume supports ecommerce and DTC strategy but not this specific niche.
- **Lifestyle & Personal** *(Optional)*: Do not select.
- **Pop Culture & Entertainment** *(Optional)*: Do not select.
- **Sports** *(Optional)*: Do not select.
- **Finance** *(Optional)*: Select.
- **Education** *(Optional)*: Select.
- **Business** *(Optional)*: Select.
- **News & Commentary** *(Optional)*: Do not select.
- **Politics** *(Optional)*: Do not select.
- **Parenting** *(Optional)*: Do not select.

---------------------------------------------------------------------------------

## 26. WATI.io — Lead Product Manager - E-commerce (August 04 Queue)
...
## 27. BIP Ventures — Junior AI Engineer | Financial Services | Venture Capital (August 08 Queue)
...
## 28. Huzzle — Senior Growth Marketing Manager (August 08 Queue)
...
- **Last name** *(Required)*: Singh
- **Photo (Optional)** *(Optional)*: Leave blank; the resume, LinkedIn profile, and portfolio already provide the relevant professional information.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Huzzle because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At McKinsey, I designed elasticity-based retail pricing across key-value and long-tail portfolios, unlocking $50M in revenue and reducing speed-to-market from six weeks to under one week through agile pods, hindcasting, and change management. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **What is your level of proficiency in English?** *(Required)*: Advanced Options: Native/Fluent / Advanced / Intermediate / Basic / Beginner.
- **What language(s) are you business proficient in?** *(Required)*: English.
- **Which of the following time zones are you able to work in? (Select all that apply)** *(Required)*: Select **US, UK, and Europe**; do not select Australia or Canada.
- **US** *(Required)*: Select.
- **UK** *(Required)*: Select - professional experience includes London and broader European work.
- **Europe** *(Required)*: Select - professional experience includes London and broader European work.
- **Australia** *(Required)*: Do not select.
- **Canada** *(Required)*: Do not select.
- **Which country do you currently reside in?** *(Required)*: San Francisco, California, United States (94108)
- **How many years of experience do you have in Growth Marketing roles?** *(Required)*: 6+ years of directly relevant growth, marketing-operations, GTM, pricing, and lifecycle work across Microsoft, Rakuten, AWS, and McKinsey.
- **Do you have hands-on experience with HubSpot marketing automation?** *(Required)*: No direct HubSpot ownership is documented; I have strong adjacent experience in marketing automation, attribution, API governance, experimentation, and lifecycle analytics. Options: YES / NO.
- **Can you list all of the tools, software and platforms that you have used in your previous roles? (List all CRM and marketing automation tools)** *(Required)*: Amazon Bedrock, RAG and evaluation tooling, Azure Confidential Computing, AI Content Safety, SQL, Rust, Apache Kafka, Apache Flink, FPGA-based systems, Random Forest modeling, W-shaped attribution, API governance, real-time budget optimization, cohort analytics, Monte Carlo simulation, and geo-lift testing.
- **Which industries have you worked in your roles? Were these B2B or B2C? (e.g., Cybersecurity - B2B, Finance - B2C etc.)** *(Required)*: Cloud and AI (B2B/enterprise), financial services and capital markets (B2B), ecommerce and marketplaces (B2C/B2B2C), retail (B2C), management consulting (B2B), and regulated public-policy/market-entry work.
- **What type of company do you prefer to work for?** *(Required)*: Select **Open to all** only.
- **Startup (Early-stage, fast-paced, building from the ground up)** *(Required)*: Do not select; “Open to all” captures the preference without contradictory selections.
- **Scale-up (Growing company, some structure but still evolving)** *(Required)*: Do not select; “Open to all” captures the preference without contradictory selections.
- **Enterprise (Well-established, structured processes)** *(Required)*: Do not select; “Open to all” captures the preference without contradictory selections.
- **Open to all** *(Required)*: Select.
- **What were you making in your previous role as a monthly salary? Mention your base and any commissions separately (if applicable).** *(Required)*: Prefer not to disclose current compensation at the application stage. I am happy to discuss expectations in the context of role scope, level, location, and total compensation.
- **What are your monthly salary expectations in USD?** *(Required)*: $10,000–$13,333 USD gross per month, negotiable based on scope and total compensation.
- **Have you ever worked with clients or companies based outside of your home country (e.g., U.S., U.K., or other countries)? If yes, please specify the countries)?** *(Required)*: Yes - I have worked across the United States, United Kingdom, India, Japan, and broader APAC markets including Vietnam and Indonesia, often coordinating global teams and senior stakeholders.
- **If you have a LinkedIn profile, please provide the URL below (if you don't have a LinkedIn profile, put N/A)** *(Required)*: https://linkedin.com/in/beastofbayarea

---------------------------------------------------------------------------------

## 29. Civica — Technical Product Manager- 12 Months Contract (August 08 Queue)
...
- **If yes, who referred you? (Optional)** *(Optional)*: No / N/A.
- **Salary Expectations** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.
...
## 30. Awesome Motive — Growth Manager (August 08 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Cover Letter (File Upload)** *(Required)*: Upload a PDF or DOCX titled `Shivam_Singh_Awesome_Motive_Cover_Letter`. Use this text: “I am excited by Awesome Motive’s focus on measurable, AI-enabled growth. At Microsoft, I built a $12M partner marketing engine that generated $50M in incremental GMV at 4.1x ROI and increased partner conversion from 5% to 24%. At Rakuten, I helped reduce CAC from $42 to $8.50, increase D30 retention from 34% to 67%, and improve LTV:CAC from 0.8 to 4.5. I would bring that combination of lifecycle economics, experimentation, attribution, and cross-functional execution to build repeatable growth systems for Awesome Motive.”
- **LinkedIn Profile URL (Optional)** *(Optional)*: https://linkedin.com/in/beastofbayarea
- **Location (City, Country)** *(Required)*: San Francisco, California, United States (94108)
- **Desired Annual Pay (in USD)** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.
- **This role requires a minimum daily overlap of 9 AM to 1 PM US Eastern Time. Can you commit to that?** *(Required)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement. Options: YES / NO.
- **Which AI tools do you use in your daily marketing work, and what have you built with them? Include one before-and-after example: something you shipped, how long it used to take, and how long it takes now.** *(Required)*: I use Amazon Bedrock, LLM copilots, RAG, prompt and model evaluation, Bedrock Guardrails, and human-in-the-loop workflows. One example is the sovereign-cloud enablement workflow I helped productize: reusable reference architectures and compliance-as-code reduced a process that could take six months to approximately two hours, while supporting a $122M pipeline.
- **Tell us about one email, lifecycle, or CRO program you personally owned. What metric were you trying to move, what did you change, and what happened? Include the numbers, even if the result was a loss.** *(Required)*: At Microsoft, I built a $12M partner marketing and demand-generation engine using propensity scoring and budget traffic-shaping, generating $50M in incremental GMV at 4.1x ROI and increasing partner conversion from 5% to 24%. At Rakuten, I helped reposition the GTM motion, reduced CAC from $42 to $8.50, increased D30 retention from 34% to 67%, and improved LTV:CAC from 0.8 to 4.5.
- **Links to work we can look at: emails, landing pages, content, portfolio, or your public writing.** *(Required)*: https://github.com/beastofbayarea and https://www.researchgate.net/profile/Shivam-Singh-188

---------------------------------------------------------------------------------

## 31. Valsoft Corporation — Product Marketing Manager (August 08 Queue)
...
- **Do you have 5+ years experience in B2B SaaS product marketing or sales enablement?** *(Required)*: Yes - my experience spans Microsoft marketing operations, AWS GTM, Rakuten growth, and McKinsey commercial strategy, with direct ownership of planning, execution, analytics, and executive outcomes. Options: YES / NO.
- **What are you annual salary expectations? (GBP)** *(Required)*: £90,000-£110,000 GBP base, negotiable based on total compensation and scope.
- **Do you have experience in the aviation industry or technical and regulated sectors?** *(Required)*: Yes - extensive technical and regulated-sector experience across banking, capital markets, cloud, AI safety, data sovereignty, Basel III, and public-policy constraints; no direct aviation-industry claim. Options: YES / NO.
- **I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application. / I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application.** *(Optional)*: Yes - I have reviewed the policy and consent to the stated processing for recruitment purposes.

---------------------------------------------------------------------------------

## 32. Sand Cherry Associates — Learning Program Manager (August 08 Queue)
...
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Sand Cherry Associates because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At McKinsey, I designed elasticity-based retail pricing across key-value and long-tail portfolios, unlocking $50M in revenue and reducing speed-to-market from six weeks to under one week through agile pods, hindcasting, and change management. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Are you legally authorized to work in the United States?** *(Required)*: Yes Options: YES / NO.
- **Are you authorized to work in the United States without requiring visa sponsorship or visa transfers? Please note that we do not work C2C.** *(Required)*: Yes Options: YES / NO.
- **Are you available to work during Central Time business hours?** *(Required)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement. Options: YES / NO.
- **Are you available to work CST hours and 20%-50% travel?** *(Required)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement. Options: YES / NO.
- **What are your annual salary expectations in USD?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.

---------------------------------------------------------------------------------

## 33. T-Tech — Product Manager - Tax Technology (August 08 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Expected salary** *(Required)*: $120,000-$160,000 USD base equivalent annually, negotiable based on scope, location, and total compensation.
...
## 34. Tiger Analytics Inc. — Associate Director- Product Manager (Retail) (August 08 Queue)
...
- **Do you have valid work authorization in the US?** *(Required)*: Yes. Options: YES / NO.
- **Will you require Tiger Analytics to sponsor you for work authorization now or in the future?** *(Required)*: No. Options: YES / NO.
- **Do you have experience in the Retail industry?** *(Required)*: Yes - at McKinsey I designed elasticity-based retail pricing across key-value and long-tail portfolios, unlocking $50M in revenue and reducing speed-to-market from six weeks to under one week; at Rakuten I led ecommerce growth and portfolio work. Options: YES / NO.
- **Are you currently based in Dallas, if not, are you open to relocating to Dallas?** *(Required)*: No - currently in San Francisco; open to relocating to Dallas.
- **Do you have experience in building and managing a successful Data & Analytics program in a Retail environment?** *(Required)*: Yes - I have led analytics-driven retail and ecommerce programs using elasticity models, cohort analytics, SQL, geo-lift testing, and experimentation to drive $50M in retail revenue and major CAC, retention, and LTV improvements. Options: YES / NO.
- **Have you managed teams across timezones? Do you have experience of on-shore off-shore model?** *(Required)*: Yes - at AWS I lead 12 workstreams across six organizations and three time zones; at D. E. Shaw I worked across New York and Hyderabad in an onshore-offshore delivery model.
- **Please share a link to your LinkedIn profile (if available)** *(Required)*: https://linkedin.com/in/beastofbayarea
- **Any additional information you want to share (if not, please write n/a)** *(Required)*: I combine retail analytics, AI product leadership, and enterprise-scale program execution, with an IIT Computer Science degree and Ross MBA.

---------------------------------------------------------------------------------

## 35. Fluent, LLC — Marketing Operations Manager, Partnerships (AdTech) (August 08 Queue)
...
- **Last name** *(Required)*: Singh
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Fluent, LLC because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At Rakuten, I won executive-committee approval for a $50M capital-redeployment thesis after portfolio-wide ROIC analysis and stress-tested a DTC expansion with a 10,000-iteration Monte Carlo model, helping avoid an estimated $20M loss. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **How did you become familiar with this opportunity? [referral, trade show, other in person event or job board (Indeed, LinkedIn, BuiltIn, Blacks In Performance Marketing, Women of Martech), etc.]** *(Required)*: No / N/A.
- **If you were referred to this opportunity by a Fluent employee, please share their name. If not, please put "N/A."** *(Required)*: No / N/A.
- **Do you now, or will you in the future, require sponsorship for employment visa status (e.g., H-1B visa status, etc.) to work legally for our Company in the United States?** *(Required)*: No
- **What are your base salary expectations?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.
- **Tell us about a time you had to coordinate across multiple teams (product, data, sales, or similar) to keep a project or program on track. What was your role in that coordination, and what happened when something didn't go as planned?** *(Required)*: At AWS I coordinated 12 workstreams across six organizations and three time zones spanning engineering, science, legal, trust and safety, GTM, localization, finance, and executives. When model quality and launch timing diverged, I established milestone gates, explicit decision owners, and shared adoption, hallucination, and safety metrics; the program secured $5M in funding and reached 25% adoption with 2.8% hallucinations.
- **Describe a dashboard, financial model, or process you've built or owned from scratch. What problem was it solving, who used it, and how did you know it was actually working?** *(Required)*: At Microsoft I built a $12M partner-capital allocation engine using Random Forest propensity scoring, W-shaped attribution, real-time yield data, and budget traffic-shaping. Marketing, sales, finance, and partner teams used it to allocate funds; success was measured through incremental GMV, ROI, conversion, and sales-cycle speed, ultimately delivering $50M incremental GMV at 4.1x ROI and lifting conversion from 5% to 24%.
- **How are you currently using AI tools in your day-to-day workflow? Give us a specific example of a task or process you've changed or improved because of it. (We use Claude here at Fluent.)** *(Required)*: I use Amazon Bedrock and LLM workflows to synthesize feedback, draft and critique requirements, prototype conversational flows, create evaluation sets, and test prompts and guardrails. In production, I combined RAG, model selection, Bedrock Guardrails, evals, and human-in-the-loop controls to reduce hallucinations to 2.8% while increasing session depth 15%.

---------------------------------------------------------------------------------

## 36. Sur — Senior Paid Media Buyer (August 08 Queue)
...
- **Photo (Optional)** *(Optional)*: Leave blank; the resume, LinkedIn profile, and portfolio already provide the relevant professional information.
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Sur because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At McKinsey, I designed elasticity-based retail pricing across key-value and long-tail portfolios, unlocking $50M in revenue and reducing speed-to-market from six weeks to under one week through agile pods, hindcasting, and change management. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **What is your desired salary for this job (USD)?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.
- **Please record a 2 sentence audio telling us why you are a good fit for the role. You can use the following link and paste it below: https://www.speakpipe.com/voice-recorder** *(Required)*: Suggested two-sentence script: “I combine analytics-led paid growth with enterprise-scale execution: at Microsoft I helped deploy $12M in partner marketing capital that generated $50M incremental GMV at 4.1x ROI. I also improved LTV:CAC from 0.8 to 4.5 at Rakuten, so I know how to turn testing, attribution, and budget decisions into profitable growth.” Record and paste the SpeakPipe link.
- **Do you currently reside in LATAM or the Caribbean?** *(Required)*: No - I reside in San Francisco, California. Options: YES / NO.
- **How many years of experience do you have managing paid Meta (Facebook/Instagram) ad campaigns?** *(Required)*: Do not select.
- **Have you managed a single paid media account with a monthly spend of $100,000 or more?** *(Required)*: Yes - I owned a $12M marketing-operations and partner-capital engine at Microsoft, well above this spend threshold. Options: YES / NO.
- **Are you currently working from an agency, in-house team, or as an independent contractor/freelancer?** *(Required)*: In-house.
- **Is your application submitted in English (including your CV)?** *(Required)*: Yes. Options: YES / NO.

---------------------------------------------------------------------------------

## 37. Boundless Networks, Inc. — Senior Technical Product Manager (August 08 Queue)
...
- **Headline** *(Required)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **Summary** *(Required)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter** *(Required)*: I am drawn to Boundless Networks, Inc. because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. For regulated financial services at Microsoft, I reframed a fully homomorphic encryption design into Azure Confidential Computing, cutting inference latency from 14 seconds to 220 milliseconds while adding AI Content Safety guardrails and bias testing. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **What are your annual salary expectations in USD?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.

---------------------------------------------------------------------------------

## 38. Mindrift — Ex-MBB Strategy Consultant - AI Training (Remote) (August 08 Queue)
...
## 39. AND Digital — Technical Product Manager (contract) (August 08 Queue)
...
- **Last name** *(Required)*: Singh
- **Photo (Optional)** *(Optional)*: Leave blank; the resume, LinkedIn profile, and portfolio already provide the relevant professional information.
- **What are the pronouns for others to use when referring to you? (Optional)** *(Optional)*: they/them
- **Open to travel** *(Optional)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement. Options: YES / NO.
- **Current Salary (Optional)** *(Optional)*: Prefer not to disclose current compensation at the application stage. I am happy to discuss expectations in the context of role scope, level, location, and total compensation.
- **Notice Period (Optional)** *(Optional)*: 2 weeks
- **Please tell us your nationality? (Optional)** *(Optional)*: Indian.
- **Cover letter (Optional)** *(Optional)*: I am drawn to AND Digital because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At McKinsey, I enabled a $1.1B APAC market entry by translating Vietnam and Indonesia data-localization rules into data-platform architecture and GTM choices for CFO, CIO, and CMO stakeholders. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **At AND Digital we embrace diversity and are committed to equal opportunities. We are actively recruiting for a diverse and inclusive workforce so want to ensure we do everything we can to support your application. Please let us know how we can support you? (Optional)** *(Optional)*: No accommodations requested at this stage; I value clear written materials and advance notice for interviews.
- **I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application. / I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application.** *(Optional)*: Yes - I have reviewed the policy and consent to the stated processing for recruitment purposes.

---------------------------------------------------------------------------------

## 40. Pack.com — Technical Product Manager (Gamified Commerce & Web3) (August 08 Queue)
...
- **Photo (Optional)** *(Optional)*: Leave blank; the resume, LinkedIn profile, and portfolio already provide the relevant professional information.
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **In which product ecosystems do you have direct experience owning, designing, or shipping technical consumer products? (Select all that apply)** *(Required)*: Select **None of the above**. The resume does not support direct ownership in CS2, loot-box, iGaming, Web3/NFT gaming, or reward-marketplace ecosystems.
- **CS2 skin economies, case openings, or case battles** *(Required)*: No direct professional experience is stated; do not select or claim this without supporting evidence.
- **Mystery-box, loot-pack, or gamified e-commerce platforms** *(Required)*: No direct professional experience is stated; do not select or claim this without supporting evidence.
- **iGaming, online casino, or gambling-style products** *(Required)*: No direct professional experience is stated; do not select or claim this without supporting evidence.
- **Web3 / Crypto gaming or digital collectibles (NFTs)** *(Required)*: No direct professional experience is stated; do not select or claim this without supporting evidence.
- **Reward-based consumer applications or gamified marketplaces** *(Required)*: No direct professional experience is stated; do not select or claim this without supporting evidence.
- **None of the above** *(Required)*: Select only if none of the domain options apply; based on the provided experience, this is appropriate for unsupported specialist domains.
- **Do you have professional or deep hands-on experience owning/building products in Web3 gaming, iGaming/casino, CS2 skin economies, case-opening platforms, or gamified marketplaces?** *(Required)*: No direct professional experience is stated; do not select or claim this without supporting evidence. Options: YES / NO.
- **If you answered 'Yes,' please briefly describe where and what was your role and contribution in that role.** *(Required)*: N/A - I would answer No to the preceding specialist Web3/iGaming experience question and would not overstate domain experience.
- **Do you intuitively understand and possess the ability to design case openings, case battles, item rarity tiers, house margins, and provably fair mechanics?** *(Required)*: No direct professional experience is stated; do not select or claim this without supporting evidence. Options: YES / NO.
- **Have you managed or built digital products that integrate crypto payments, Web3 wallet connections (MetaMask/Phantom), or smart contract interactions?** *(Required)*: No direct professional experience is stated; do not select or claim this without supporting evidence. Options: YES / NO.
- **Do you have direct experience writing technical user stories, API requirements, and acceptance criteria for software engineering teams in tools like Linear, Jira, or Notion?** *(Required)*: Yes — extensive product and technical platform work includes requirements, APIs, acceptance criteria, and engineering collaboration. Options: YES / NO.
- **Are you currently based in the United States, Canada, or Latin America?** *(Required)*: Yes — United States. Options: YES / NO.
- **Desired salary (Yearly USD)** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.

---------------------------------------------------------------------------------

## 41. Weekday AI — demand generation (August 08 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **What’s your current salary? (in lakhs per annum)** *(Required)*: Prefer not to disclose current compensation at the application stage. I am happy to discuss expectations in the context of role scope, level, location, and total compensation.
- **How many days is your notice period?** *(Required)*: 14 days

---------------------------------------------------------------------------------

## 42. Pinewood.AI — Product Manager - Fixed Operations (August 08 Queue)
...
- **Where are you based? This position is hybrid in Fort Lauderdale, Florida. Please only apply if you can be flexible.** *(Required)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement.
...
## 43. Pavago — Paid Media Specialist (August 08 Queue)
...
- **Last name** *(Required)*: Singh
- **Please share your LinkedIn profile URL.** *(Required)*: https://linkedin.com/in/beastofbayarea
- **What is your salary expectations per month in USD for this role?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.

---------------------------------------------------------------------------------

## 44. GoTymeX — Product Manager | Service Interactions (August 08 Queue)
* **Application Form URL**: `https://apply.workable.com/j/8853CE2E0C/apply`
...
## 45. Oceans — Digital Marketing Manager (August 08 Queue)
...
- **Photo (Optional)** *(Optional)*: Leave blank; the resume, LinkedIn profile, and portfolio already provide the relevant professional information.
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Oceans because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At McKinsey, I designed elasticity-based retail pricing across key-value and long-tail portfolios, unlocking $50M in revenue and reducing speed-to-market from six weeks to under one week through agile pods, hindcasting, and change management. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Tell us why this opportunity was exciting to you. What made you want to apply? *** *(Required)*: The role combines complex customer problems, measurable product outcomes, and cross-functional execution. I am especially drawn to the opportunity to pair technical depth with customer-led strategy and measurable growth.
- **How does your past experience make you the perfect candidate for this role? *** *(Required)*: At Microsoft, I built a $12M partner marketing and demand-generation engine using propensity scoring and budget traffic-shaping, generating $50M in incremental GMV at 4.1x ROI and increasing partner conversion from 5% to 24%. At Rakuten, I helped reposition the GTM motion, reduced CAC from $42 to $8.50, increased D30 retention from 34% to 67%, and improved LTV:CAC from 0.8 to 4.5. At AWS, I have led agentic AI and copilot strategy across 12 workstreams, using customer telemetry and experiments to increase session depth by 15%, reduce hallucinations from 8% to 2.8% with RAG and guardrails, and compress client rollout cycles from six months to two hours.
- **What do you consider to be your significant career achievements, and why? What is the key strength/(s) that you possess that helped you? *** *(Required)*: At Microsoft, I built a $12M partner marketing and demand-generation engine using propensity scoring and budget traffic-shaping, generating $50M in incremental GMV at 4.1x ROI and increasing partner conversion from 5% to 24%. At Rakuten, I helped reposition the GTM motion, reduced CAC from $42 to $8.50, increased D30 retention from 34% to 67%, and improved LTV:CAC from 0.8 to 4.5. At AWS, I have led agentic AI and copilot strategy across 12 workstreams, using customer telemetry and experiments to increase session depth by 15%, reduce hallucinations from 8% to 2.8% with RAG and guardrails, and compress client rollout cycles from six months to two hours.
- **Tell us about a difficult encounter you experienced in the workplace and how you handled it. *** *(Required)*: I have handled cross-functional disagreements by making the customer outcome and decision criteria explicit, separating reversible from irreversible choices, and using a small measurable experiment to resolve uncertainty. This creates alignment without hiding trade-offs or slowing execution.
...
- **What is your expected salary? *** *(Required)*: $120,000-$160,000 USD base equivalent annually, negotiable based on scope, location, and total compensation.
- **Do you have any prior experience working overnight shifts? If yes, what were the working hours? *** *(Required)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement.
...
- **Where did you first hear about this opportunity?** *(Required)*: Select **LinkedIn** only.
- **LinkedIn** *(Required)*: Select - LinkedIn.
- **Instagram** *(Required)*: Do not select.
- **TikTok** *(Required)*: Do not select.
- **Reddit** *(Required)*: Do not select.
- **An event** *(Required)*: Do not select.
- **Someone I know** *(Required)*: Do not select.
- **"I hereby confirm that everything stated in the application is true to the best of my knowledge” *Please print your full name below to confirm*** *(Required)*: Shivam Singh.
- **Would you like to stay updated with the latest news and opportunities from Oceans? *** *(Required)*: No.

---------------------------------------------------------------------------------

## 46. Sago — Program Manager, Research Ops (temporary) (August 08 Queue)
...
- **Photo (Optional)** *(Optional)*: Leave blank; the resume, LinkedIn profile, and portfolio already provide the relevant professional information.
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **Legal Name (First and Last)** *(Required)*: Shivam Singh
- **Desired pay rate** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.
- **Date Available** *(Required)*: Two weeks after accepting an offer.
- **I recognize and understand this is a temporary position and I would be required to work full-time hours (35+ hours/week) with Friday through Monday as required workdays.** *(Required)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement. Options: YES / NO.
- **I understand this is an on-site position based in close proximity to Penn Station, NYC and am willing to consider a position requiring a daily commute.** *(Required)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement. Options: YES / NO.

---------------------------------------------------------------------------------

## 47. Capital Factory — Investor Relations Associate (August 08 Queue)
...
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Capital Factory because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At McKinsey, I designed a maker-taker pricing and liquidity flywheel that grew institutional trading volume from $215B to $371B and recurring revenue from $45M to $213M through elasticity, take-rate, and contribution-margin analysis. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Do you know anyone that works at Capital Factory or is a member? If so, who?** *(Required)*: No / N/A.
- **Have you been referred to apply for this role with Capital Factory? If so, who referred you?** *(Required)*: No / N/A.
- **How would you describe Capital Factory in your own words?** *(Required)*: The role combines complex customer problems, measurable product outcomes, and cross-functional execution. I am especially drawn to the opportunity to pair technical depth with customer-led strategy and measurable growth.
- **Are you legally authorized to work in the United States?** *(Required)*: Yes Options: YES / NO.
- **What are your annual salary expectations in USD?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.

---------------------------------------------------------------------------------

## 48. Bayut | dubizzle — Product Manager - Growth (August 08 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Which university or school did you attend for your highest qualification? (Optional)** *(Optional)*: University of Michigan, Stephen M. Ross School of Business (MBA).
- **Are you currently based in the UAE?** *(Required)*: No — current location is San Francisco, California. Options: YES / NO.
- **Do you have at least 4–6 years of experience in product management and/or growth roles?** *(Required)*: Yes - 10+ years across product, growth, platforms, and strategy. Options: YES / NO.
- **Have you owned end-to-end conversion/funnel performance for a product or feature (i.e., held direct accountability for CVR/CPL-type metrics)?** *(Required)*: Yes - I have owned funnel economics and structured experimentation using cohort analysis, SQL, geo-lift tests, elasticity models, Monte Carlo simulation, and executive decision models. Options: YES / NO.
- **Do you have hands-on experience running structured A/B or multivariate testing programs (not just requesting them from another team)?** *(Required)*: Yes - I have owned funnel economics and structured experimentation using cohort analysis, SQL, geo-lift tests, elasticity models, Monte Carlo simulation, and executive decision models. Options: YES / NO.
- **Are you comfortable working in Excel at an analytical level (pivot tables, formulas, cohort/funnel analysis)?** *(Required)*: Yes - I have owned funnel economics and structured experimentation using cohort analysis, SQL, geo-lift tests, elasticity models, Monte Carlo simulation, and executive decision models. Options: YES / NO.
- **Have you been referred by someone/ know someone who is currently at any brands of Dubizzle group? Please mention their full name and department.** *(Required)*: No / N/A.

---------------------------------------------------------------------------------

## 49. moomoo — Assistant Marketing Manager (Brand & Creative Strategy) (August 08 Queue)
...
- **Are you a friend or family of a current employee of the company?** *(Required)*: No / N/A. Options: Yes / No.
- **What is your Expected Gross Salary?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.

---------------------------------------------------------------------------------

## 50. OnBuy — Principal Product Manager - eCommerce (August 08 Queue)
...
- **What are your annual salary expectations in GBP?** *(Required)*: £110,000-£130,000 GBP base, negotiable based on total compensation and scope.
- **I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application. / I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application.** *(Optional)*: Yes - I have reviewed the policy and consent to the stated processing for recruitment purposes.

---------------------------------------------------------------------------------

## 51. Maker Lab — Audience Strategy Lead (August 08 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Cover letter (Optional)** *(Optional)*: I am drawn to Maker Lab because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At Rakuten, I won executive-committee approval for a $50M capital-redeployment thesis after portfolio-wide ROIC analysis and stress-tested a DTC expansion with a 10,000-iteration Monte Carlo model, helping avoid an estimated $20M loss. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Are you currently based in Bangalore/Gurgaon/Mumbai, India?** *(Required)*: No — current location is San Francisco, California. Options: YES / NO.

---------------------------------------------------------------------------------

## 52. Mindera — Retail Product Manager - Contract - Outside IR35 (August 08 Queue)
...
- **Last name** *(Required)*: Singh
- **Photo (Optional)** *(Optional)*: Leave blank; the resume, LinkedIn profile, and portfolio already provide the relevant professional information.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Mindera because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At AWS, I built a bottom-up GenAI investment case with market sizing, attach-rate scenarios, sensitivity analysis, and a $100M+ GMV model, securing $5M in milestone-gated funding against competing bets. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **This position is a 6 month contract and requires you to work onsite in London Paddington 3 days a week. Are you happy with this?** *(Required)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement. Options: YES / NO.
- **This role requires you to start from 1st April. Does this align with your expectations?** *(Required)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement. Options: YES / NO.
- **I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application. / I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application.** *(Optional)*: Yes - I have reviewed the policy and consent to the stated processing for recruitment purposes.

---------------------------------------------------------------------------------

## 53. Culligan UK limited — Product Manager (August 08 Queue)
...
- **Last name** *(Required)*: Singh
- **Headline (Optional)** *(Optional)*: Principal, AI Products & Platforms | GenAI, B2B SaaS, Data & Growth
- **What is your current notice period?** *(Required)*: 2 weeks
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Culligan UK limited because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At Microsoft, I built a $12M marketing-operations and partner-capital engine using propensity scoring, W-shaped attribution, real-time budget traffic-shaping, and API governance; it produced $50M incremental GMV at 4.1x ROI and raised partner conversion from 5% to 24%. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **Have you been responsible for launching and commercialising products or services in a B2B environment?** *(Required)*: Yes. At Microsoft, I built a $12M partner marketing and demand-generation engine using propensity scoring and budget traffic-shaping, generating $50M in incremental GMV at 4.1x ROI and increasing partner conversion from 5% to 24%. At Rakuten, I helped reposition the GTM motion, reduced CAC from $42 to $8.50, increased D30 retention from 34% to 67%, and improved LTV:CAC from 0.8 to 4.5. Options: YES / NO.
- **Have you owned or contributed to product positioning, pricing, and value proposition development?** *(Required)*: Yes — I have owned or shaped GTM positioning, value propositions, commercial strategy, and data-driven acquisition and retention decisions across Microsoft, Rakuten, and AWS.
- **Is your product management experience predominantly within SaaS/digital products or physical products?** *(Required)*: Yes — predominantly enterprise B2B SaaS and digital platforms.
- **I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application. / I have read, understand and accept the content of the Privacy Notice and consent to the processing of my data as part of this application.** *(Optional)*: Yes - I have reviewed the policy and consent to the stated processing for recruitment purposes.

---------------------------------------------------------------------------------

## 54. Hyprwork — Creative Strategist, Performance Marketing (August 08 Queue)
...
## 55. Treatwell — Head of Product Marketing (August 08 Queue)
...
- **Can you please confirm your salary expectations?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.
...
## 56. TechOp Solutions International — Program Manager- Call Center (August 08 Queue)
...
- **Are you a US Citizen? (Must be able to obtain required security clearance successfully)** *(Required)*: US work-authorized without sponsorship; citizenship or passport status should be selected according to the candidate’s legal document. Options: YES / NO.
...
## 57. Vasion — Program Manager, PDLC (August 08 Queue)
...
- **Do you have any relatives currently working for us? If so, please provide us with their name.** *(Required)*: No / N/A.
- **Summary (Optional)** *(Optional)*: IIT Computer Science graduate and Ross MBA with 10+ years across AWS, D. E. Shaw, Microsoft, McKinsey, and Rakuten. I lead AI products and platforms at AWS, combining technical architecture, product strategy, analytics, and go-to-market execution.
- **Cover letter (Optional)** *(Optional)*: I am drawn to Vasion because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At McKinsey, I enabled a $1.1B APAC market entry by translating Vietnam and Indonesia data-localization rules into data-platform architecture and GTM choices for CFO, CIO, and CMO stakeholders. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
- **What is your desired salary?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.
- **Are you legally authorized to work in the U.S. on a full-time basis?** *(Required)*: Yes Options: YES / NO.
- **Are you legally authorized to work in the United States without continuing sponsorship for employment visa status, now or in the future? (e.g., H-1B or H4)** *(Required)*: Yes Options: YES / NO.
...
## 58. VIVANT CORP — Growth Marketing Coordinator (August 08 Queue)
...
- **Last name** *(Required)*: Singh
- **What are your annual salary expectations in USD?** *(Required)*: $120,000–$160,000 USD base annually, negotiable based on role scope and total compensation.
- **How many years of hands-on experience do you have executing B2B marketing campaigns from start to finish?** *(Required)*: 6+ years of directly relevant growth, marketing-operations, GTM, pricing, and lifecycle work across Microsoft, Rakuten, AWS, and McKinsey.
- **This is a hybrid role. Are you comfortable working 2 days onsite and 3 days remotely each week?** *(Required)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement. Options: YES / NO.
- **Are you able to work onsite at our office in Farmers Branch, Texas? Please note that we are unable to provide relocation assistance at this time** *(Required)*: Yes - I am open to the stated schedule, travel, hybrid, or on-site requirement. Options: YES / NO.
- **Do you have at least 3 years of hands-on experience executing B2B marketing initiatives for a company with annual revenue between approximately $5M and $75M?** *(Required)*: Yes - my experience spans Microsoft marketing operations, AWS GTM, Rakuten growth, and McKinsey commercial strategy, with direct ownership of planning, execution, analytics, and executive outcomes. Options: YES / NO.
- **Have you independently executed B2B marketing campaigns from planning through execution and performance reporting (rather than only assisting another team member)?** *(Required)*: Yes - my experience spans Microsoft marketing operations, AWS GTM, Rakuten growth, and McKinsey commercial strategy, with direct ownership of planning, execution, analytics, and executive outcomes. Options: YES / NO.
- **Which responsibilities have you personally owned professionally? (Select all that apply)** *(Required)*: Select **Creating marketing content (website copy, emails, landing pages, lead magnets, etc.)** and **Building email nurture campaigns or marketing-automation sequences**. Do not select WordPress administration, blog writing, or social-media management because those are not directly documented.
- **Updating and managing a WordPress website** *(Required)*: Do not select - direct hands-on ownership is not documented.
- **Writing blog articles** *(Required)*: Do not select - direct hands-on ownership is not documented.
- **Creating marketing content (website copy, emails, landing pages, lead magnets, etc.)** *(Required)*: Select - supported by marketing operations, GTM, lifecycle, and partner enablement work.
- **Managing social media content** *(Required)*: Do not select - direct hands-on ownership is not documented.
- **Building email nurture campaigns or marketing automation sequences** *(Required)*: Select - supported by marketing operations, GTM, lifecycle, and partner enablement work.
- **Do you have professional experience using GA4, Google Tag Manager, Looker Studio, WordPress, and a marketing automation platform (such as GoHighLevel, HubSpot, ActiveCampaign, or similar)?** *(Required)*: No - these exact tools are not documented; my adjacent experience includes attribution, SQL, cohort analytics, geo-lift testing, API governance, and marketing automation. Options: YES / NO.
- **Can you demonstrate measurable marketing results (e.g., traffic growth, MQLs, conversions, engagement, or ROI) from your previous roles?** *(Required)*: Yes - $50M incremental GMV at 4.1x ROI, partner conversion from 5% to 24%, CAC from $42 to $8.50, D30 retention from 34% to 67%, and LTV:CAC from 0.8 to 4.5. Options: YES / NO.
- **Are you legally authorized to work in the United States without requiring current or future visa sponsorship?** *(Required)*: Yes Options: YES / NO.

---------------------------------------------------------------------------------

## 59. Rokt — Senior Product Manager - Customer Data Platform (August 08 Queue)
...
- **First name** *(Required)*: Shivam
- **Last name** *(Required)*: Singh
- **Cover letter (Optional)** *(Optional)*: I am drawn to Rokt because the role calls for someone who can move from insight to execution without losing technical or commercial rigor. At AWS, I led an agentic GenAI shopping copilot across 12 workstreams, using RAG, Bedrock, guardrails, evals, and human review to reach 25% adoption, 70% brand favorability, 2.8% hallucinations, and 15% higher session depth. Beyond that example, my career spans strategy consulting, regulated financial platforms, AI product leadership, growth economics, and global operating programs. That range would let me contribute a fresh perspective, partner effectively with specialists, and adapt quickly as the role evolves.
