# SmartRecruiters Master Application & Answer Guide
...
Use these in every live form unless a role section overrides them.

| Field | Answer |
|---|---|
| Legal first name | Shivam |
| Preferred first name | Shiv |
| Middle name | Leave blank |
| Last name | Singh |
| Legal full name | Shivam Singh |
| Phonetic name | Shih-vum Sing |
| Phone country code | +1 |
| Phone | 650-283-3478 |
| Street | 447 Sutter Street |
| Address line 2 | Ste 506 |
| City | San Francisco |
| State | California |
| Postal code | 94108 |
...
| Portfolio/publications | https://www.researchgate.net/profile/Shivam-Singh-188 |
| Highest degree | Master’s degree |
| School | University of Michigan, Stephen M. Ross School of Business |
| Degree | MBA - Strategy, Technology & Operations |
| Additional degree | B.Tech, Computer Science & Engineering, Indian Institute of Technology |
| Notice / earliest start | Two weeks after accepting an offer |
| Source | LinkedIn |
...
| Sex | Male |
| Gender identity | Man |
| Race / ethnicity | Asian / Southern or Central Asian |
...
I am excited by the opportunity to build Renesas’s HPAC product-management organization at the point where AI-compute growth, data-center economics, and power-management constraints converge. At AWS, I set strategy and delivery for an agentic GenAI platform across 12 workstreams, six organizations, and three time zones, secured $5M in milestone-gated funding, and translated technical capabilities into $20M+ of customer commitments and a $122M pipeline. Earlier, I led a roughly $10M real-time data and risk platform at D. E. Shaw across 15+ engineers, scaling throughput to 5.4M messages per second while unlocking $85M in regulatory capital. That combination of portfolio economics, technical depth, global leadership, and accountable operating cadence maps directly to owning HPAC roadmap, team design, pricing, funnel health, and market adoption. I would bring urgency, analytical rigor, and a customer-first culture while rapidly deepening product-specific power-management expertise.
...
Renesas’s digital multiphase portfolio is compelling because the next wave of AI infrastructure will be won not only on model performance but on power density, reliability, cost, and scalable system design. My product career has repeatedly translated technically complex infrastructure into roadmaps and commercial outcomes. At AWS, I built a $100M+ GMV investment model, secured $5M in funding, and shaped sovereign-cloud reference architectures that reduced deployment time from six months to two hours. At D. E. Shaw, I led a Rust/Kafka/Flink/FPGA platform that cut latency from 90ms to 4.2ms and scaled throughput to 5.4M messages per second. I would apply the same customer discovery, market-requirements, portfolio prioritization, and business-case discipline to HPAC while partnering closely with electrical-engineering specialists. My MBA and computer-science foundation complement practical experience making trade-offs across performance, economics, adoption, and execution.
...
Asphalt Legends is the kind of product challenge I enjoy most: a global live experience where player delight, engagement loops, monetization, content cadence, and long-term brand equity must reinforce one another. At Rakuten, I used cohort analytics, SQL, geo-lift testing, and a 10,000-iteration Monte Carlo model to redirect a consumer-growth strategy; the resulting model improved D30 retention from 34% to 67%, LTV:CAC from 0.8 to 4.5, CAC from $42 to $8.50, and payback from 18 to four months. At Microsoft, I built a data-driven partner and marketing engine that generated $50M in incremental GMV at 4.1x ROI. I would bring that experimentation discipline to events, offers, segmentation, cross-platform player journeys, and revenue strategy while protecting the premium racing experience. My leadership across product, analytics, creative, engineering, finance, and GTM teams equips me to orchestrate a complex live-product portfolio at global scale.
...
- **Published range:** `$150,000-$180,000 base plus target bonus`
- **Expected compensation:** `$180,000 base plus target bonus/equity; negotiable.`

### Message to the hiring team

Freshworks’s promise of uncomplicated, people-first AI is exactly the positioning challenge I want to own: turn sophisticated agentic capabilities into clear customer value, credible proof, and adoption. At AWS, I led an agentic GenAI program across 12 workstreams, hardened RAG and model selection on Bedrock, deployed guardrails and evaluation controls, and achieved 25% adoption, 70% brand favorability, 2.8% hallucinations, and a 15% increase in session depth. I also converted sovereign-cloud capabilities into reference architectures, executive narratives, $20M+ in commitments, and a $122M pipeline. At Microsoft, I built a $12M marketing and partner-capital engine that produced $50M incremental GMV at 4.1x ROI. I can therefore partner credibly with product and engineering while creating sharp positioning, launch strategy, enablement, customer stories, and demand programs for Freshservice AI. The opportunity to make powerful enterprise AI feel fast, safe, and intuitive is a natural extension of my work.
...
Ubisoft’s Live 360 portfolio sits at a powerful intersection of platform product management, player communication, content operations, localisation, and measurable engagement. At AWS, I led a global agentic-AI program across engineering, science, legal, trust and safety, GTM, localisation, finance, and executive teams, building the governance and operating cadence needed to ship safely across three time zones. At Rakuten, I used cohort analytics and experimentation to improve D30 retention from 34% to 67% and LTV:CAC from 0.8 to 4.5. Those experiences translate directly to discovering internal production workflows, prioritising a platform roadmap, improving multi-channel publishing, and defining outcome metrics across in-game, Connect, web, and mobile touchpoints. I would bring a player-centered mindset, strong platform judgment, and practical AI/automation fluency to help Ubisoft teams create targeted, scalable, and trustworthy communications for millions of players.
...
This role is unusually close to my current work: owning the customer problem and outcomes for an agentic platform while treating developer experience, APIs, SDKs, documentation, trust, and adoption as the product. At AWS, I lead strategy and delivery for an agentic GenAI platform across 12 workstreams, using Amazon Bedrock, RAG, model selection, guardrails, evaluations, and human-in-the-loop controls. The program reached 25% adoption, 70% brand favorability, 2.8% hallucinations, and 15% deeper sessions. I also built sovereign-cloud reference architectures and compliance-as-code patterns that reduced deployment from six months to two hours and unlocked a $122M pipeline. Earlier at D. E. Shaw, I led high-throughput data platforms with measurable reliability, latency, and capital-efficiency outcomes. I would bring technical credibility with developers, disciplined discovery, outcome-based roadmaps, and principal-level coaching to IFS’s IDP and agentic-AI portfolio.
...
Canva’s GenAI localisation program needs someone who can turn a sprawling, multilingual quality problem into a measurable operating system without losing technical credibility. At AWS, I coordinate 12 workstreams across six organizations and three time zones, including localisation, evaluation, science, legal, trust and safety, engineering, finance, and GTM. I have built RAG and model-selection experiments, deployed guardrails and human-in-the-loop controls, and tied quality metrics to adoption and brand outcomes. I also transformed regulated deployment requirements into repeatable reference architectures and automation that reduced lead time from six months to two hours. That combination maps directly to evaluation operations, human-review pipelines, vendor and capacity governance, lightweight dashboards, automated eval foundations, and executive communication. I would bring calm structure, high standards, and hands-on analytical judgment to help Canva define what “good” localisation looks like and scale it across languages.
...
NBC News Digital’s mission—helping millions of people understand the world through trusted, real-time products—makes platform quality, audience insight, and product judgment unusually consequential. I have led platforms where reliability, speed, economics, and user trust must move together. At D. E. Shaw, I owned a roughly $10M real-time data and risk platform across 15+ engineers, cut latency from 90ms to 4.2ms, scaled throughput to 5.4M messages per second with zero dropped packets through market crashes, and unlocked $85M in capital. At AWS, I lead an AI product portfolio across 12 workstreams and built adoption, trust, and evaluation metrics into the roadmap. I would bring rigorous discovery, data-informed prioritisation, Agile team leadership, and business-case discipline to audience- and revenue-driving platform initiatives across NBC News, Today, Telemundo, and local products.
...
- Disability: **Yes, I have or previously had a disability**.
- Name: **Shivam Singh**.
- Today’s date: enter the actual submission date in `MM/DD/YYYY`.
...
Renesas’s EMEA mandate requires more than communications: it needs a regional commercial leader who can connect customer roadmaps, design-win funnels, distribution, pricing, and product strategy to revenue. At Microsoft, I built a $12M partner-capital and marketing engine across global stakeholders, using propensity scoring, attribution, API governance, and real-time budget allocation to generate $50M incremental GMV at 4.1x ROI and lift funded-partner conversion from 5% to 24%. At McKinsey, I combined regulatory engineering, market-entry strategy, and executive alignment to enable a $1.1B APAC expansion. At AWS, I translate technical cloud and AI capabilities into reference architectures and executive value stories that have produced $20M+ in commitments and a $122M pipeline. I would bring that blend of technical positioning, account strategy, channel enablement, funnel governance, and growth accountability to Renesas Embedded Processing across EMEA.
...
Freshworks is attacking a problem I have seen repeatedly from both the customer and builder side: enterprise systems become harder to operate than the work they were purchased to simplify. I am inspired by the company’s insistence that enterprise-grade power and intuitive experiences are not opposites, especially as AI reshapes service management. At AWS, I lead an agentic GenAI portfolio across 12 workstreams and have combined RAG, model selection, guardrails, evaluation, and human oversight to achieve 25% adoption, 70% brand favorability, 2.8% hallucinations, and 15% deeper sessions. At D. E. Shaw, I led a high-throughput data platform with step-change latency, accuracy, and capital outcomes. I want to bring that same technical and commercial discipline to Freshservice: make intelligent service management feel modern, trustworthy, and measurably easier.

### Why this role and career aspiration

The Staff PM role is compelling because it rewards principal-level influence without requiring formal authority: define a bold product thesis, earn trust with customers and engineers, make hard portfolio trade-offs, and align design, GTM, customer success, and delivery around outcomes. That has been the pattern of my strongest work—from securing $5M in milestone-gated AI funding to coordinating six organisations across three time zones and converting regulated-cloud requirements into scalable product patterns. Over the next several years, I want to help establish the category standard for AI-native ITSM: agents that resolve work safely, learn from operational context, expose their reasoning and controls, and improve both employee experience and service economics. Freshworks offers the product surface, customer scale, and bias for simplicity to make that ambition concrete.
...
NBCUniversal’s Design Program Manager role is compelling because world-class streaming experiences depend on invisible operating excellence: clear priorities, coordinated discovery, dependable design delivery, fast decisions, and disciplined handoffs from concept through launch. At AWS, I lead 12 workstreams across six organisations and three time zones, aligning product, engineering, science, legal, trust and safety, localisation, finance, GTM, and executives around a single roadmap and measurable outcomes. At Microsoft, I built governance, APIs, analytics, and operating cadences for a $12M global program that generated $50M incremental GMV. At McKinsey, I helped create Agile pods that reduced speed-to-market from six weeks to under one week. I would bring structured planning, proactive risk and dependency management, concise executive communication, and empathy for design and product workflows to Peacock, NBC, Bravo, Sports, and NBCU International initiatives.
...
Mirantis is building at the infrastructure layer where AI performance, sovereignty, and operational control are decided. I bring rare product fluency across distributed systems, regulated cloud architecture, and commercial platform strategy. At D. E. Shaw, I led a roughly $10M real-time platform using Rust, Kafka, Flink, and FPGA, cut risk latency from 90ms to 4.2ms, scaled throughput from 1M to 5.4M messages per second, and maintained zero dropped packets through market crashes. At AWS, I architected sovereign-cloud reference patterns, resiliency controls, and deployment automation that reduced time-to-deploy from six months to two hours while creating a $122M pipeline. I would apply that background to k0rdent AI networking strategy, customer requirements, backlog trade-offs, reference architectures, and ecosystem positioning across GPU clouds, NeoClouds, telcos, and sovereign environments.

### Live screening answers

- LinkedIn URL: **https://linkedin.com/in/beastofbayarea**.
...
QAD has a differentiated manufacturing-AI story: the winning layer is not a generic model, but domain intelligence, governed data, traceable action, and execution inside enterprise workflows. I have repeatedly turned that kind of technical differentiation into buyer value. At AWS, I translated GenAI, guardrails, sovereign-cloud controls, and reference architectures into executive narratives that unlocked $20M+ in commitments and a $122M pipeline. At Microsoft, I built a $12M marketing and partner-capital engine that produced $50M incremental GMV at 4.1x ROI. At McKinsey, I crafted market-entry, pricing, and transformation cases for CFO, CIO, and CMO audiences, including a $1.1B APAC expansion. I would bring QAD a coherent messaging architecture, technically credible proof points, competitive and buyer intelligence, pricing input, thought leadership, customer stories, and sales narratives that make Champion AI’s System-of-Action differentiation unmistakable.
...
NBCUniversal’s Salesforce Product Manager role is a chance to improve the operating backbone of Global TV Distribution: translate complex business processes into a coherent roadmap, prioritise production support and technical debt alongside growth, and drive adoption across business and technical teams. At Microsoft, I built a global partner and marketing-operations engine with CRM-adjacent workflows, API governance, attribution, scoring, budget controls, and cross-functional service processes. It generated $50M incremental GMV, improved funded-partner conversion from 5% to 24%, and shortened sales cycles. At AWS, I now coordinate 12 product workstreams across technical, legal, finance, operations, and GTM stakeholders, turning ambiguous requirements into governed delivery plans. I would bring enterprise workflow judgment, strong discovery and requirements practices, release and backlog discipline, integration awareness, and a relentless focus on data quality and user adoption.
