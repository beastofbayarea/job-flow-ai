...
Q04_PATH = Path("data/application-queues/lever-job-search-2026-08-04.json")
Q08_PATH = Path("data/application-queues/lever-job-search-2026-08-08.json")
...
def run():
    ...
    for idx, j in enumerate(all_jobs, 1):
        ...
        lines.append(f"17. **Resume Attachment**: `data/resumes/resume-general.pdf`")
    ...
    print(f"Successfully generated 100% complete field answers for ALL {len(all_jobs)} Lever applications!")
    print(f"Saved to:\n - {DATA_MD}\n - {ARTIFACT_MD}")
